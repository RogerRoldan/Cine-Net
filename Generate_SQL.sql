...
(
  ...
  PRIMARY KEY (cod_persona, cod_pelicula),
...
COPY tiquete(cod_tiquete,cod_usuario,cod_taquilla,cod_sala,hora_funcion,fecha_funcion,num_silla,tipo_pago,pago_total) FROM '/tmp/tiquete.csv' DELIMITER ',' CSV HEADER;
